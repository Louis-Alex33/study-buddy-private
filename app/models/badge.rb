class Badge < ApplicationRecord
  ...
  def self.seed_badges!
    badges = [
      ...
      { name: "Premier pas", description: "Créer ton premier cours", icon: "fa-book", category: "courses", points_required: 1 },
      ...
      { name: "Curieux", description: "Compléter ton premier quiz", icon: "fa-question-circle", category: "quizzes", points_required: 1 },
      ...
      { name: "Mémorisation", description: "Créer ton premier set de flashcards", icon: "fa-layer-group", category: "flashcards", points_required: 1 },
      ...
      { name: "Social", description: "Ajouter ton premier ami", icon: "fa-user-friends", category: "social", points_required: 1 },
